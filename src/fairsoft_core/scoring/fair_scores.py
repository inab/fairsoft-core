from fairsoft_core.models.fair_metrics import FAIRscores
...
def compute_fair_scores(instance: Instance) -> dict:
    ...
    instance.scores.F = (
        0.4 * instance.scores.F1 + 0.2 * instance.scores.F2 + 0.4 * instance.scores.F3
    )
    ...
    if instance.super_type == "web" or instance.super_type == "both":
        ...
        instance.scores.A1 = (
            0.5 * instance.metrics.A1_2
            + 0.2 * instance.metrics.A1_3
            + 0.1 * instance.metrics.A1_4
            + 0.2 * instance.metrics.A1_5
        )
        instance.scores.A3 = (1 / 4) * (
            instance.metrics.A3_2
            + instance.metrics.A3_3
            + instance.metrics.A3_4
            + instance.metrics.A3_5
        )
    ...
    instance.scores.I1 = (
        0.5 * instance.metrics.I1_1 + 0.3 * instance.metrics.I1_3 + 0.2 * instance.metrics.I1_4
    )
    instance.scores.I2 = 0.5 * instance.metrics.I2_1 + 0.5 * instance.metrics.I2_2
    instance.scores.I3 = (1 / 3) * (
        instance.metrics.I3_1 + instance.metrics.I3_2 + instance.metrics.I3_3
    )
    instance.scores.I = (
        0.6 * instance.scores.I1 + 0.1 * instance.scores.I2 + 0.3 * instance.scores.I3
    )
    ...
    instance.scores.R = (
        0.3 * instance.scores.R1
        + 0.3 * instance.scores.R2
        + 0.2 * instance.scores.R3
        + 0.2 * instance.scores.R4
    )
