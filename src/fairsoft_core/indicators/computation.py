...
class IndicatorComputation:
    ...
    def compute_findability(self):
        self.instance.metrics.F1_1, self.instance.logs.F1_1 = (
            True,
            ["The metadata is assigned a name to be identified."],
        )
    ...
    def compute_accessibility(self):
        ...
        self.instance.metrics.A2_1, self.instance.logs.A2_1 = (
            False,
            ["This indicator is currently not measured."],
        )
        self.instance.metrics.A2_2, self.instance.logs.A2_2 = (
            False,
            ["This indicator is currently not measured."],
        )
    ...
    def compute_interoperability(self):
        ...
        self.instance.metrics.I1_5, self.instance.logs.I1_5 = (
            False,
            ["This indicator is currently not measured."],
        )
    ...
    def compute_reusability(self):
        ...
        self.instance.metrics.R1_2, self.instance.logs.R1_2 = (
            False,
            ["This indicator is currently not measured."],
        )
        ...
        self.instance.metrics.R4_3, self.instance.logs.R4_3 = (
            False,
            ["This indicator is currently not measured."],
        )
