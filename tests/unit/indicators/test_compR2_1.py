from fairsoft_core.indicators.r_indicators import compR2_1
from fairsoft_core.models.instance import Documentation, Instance, License


# Test cases
def test_compR2_1_with_valid_documentation():
    instance = Instance(
        documentation=[Documentation(type="License", url="https://github.com")], license=[]
    )
...
def test_compR2_1_with_invalid_documentation():
    instance = Instance(documentation=[Documentation(type="License", url="")], license=[])
    result, logs = compR2_1(instance)
    assert result == False
...
def test_compR2_1_with_no_documentation_and_no_license():
    instance = Instance(documentation=[], license=[])
    result, logs = compR2_1(instance)
    assert result == False
