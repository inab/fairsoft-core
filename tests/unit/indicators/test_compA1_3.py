...
from fairsoft_core.indicators.a_indicators import compA1_3
from fairsoft_core.models.instance import Documentation, Instance
...
def create_instance(type, download, source, documentation, inst_instr=False):
    return Instance(
        ...
        source=source,
        documentation=[
            Documentation(type=doc["type"], url=HttpUrl(doc["url"])) for doc in documentation
        ]
        if documentation
        else [],
...
def test_compA1_3_with_no_web_and_download():
    instance = create_instance(
        type="cmd", download=["https://github.com"], source=[], documentation=[]
    )
...
def test_compA1_3_with_no_web_and_valid_source():
    instance = create_instance(type="lib", download=[], source=["bioconda"], documentation=[])
    result, logs = compA1_3(instance)
    assert result == True
...
def test_compA1_3_with_no_web_and_invalid_source():
    instance = create_instance(type="cmd", download=[], source=["random_source"], documentation=[])
    result, logs = compA1_3(instance)
    print(logs)
    assert result == False
...
def test_compA1_3_with_no_web_and_empty_download_source_and_documentation():
    instance = create_instance(type="cmd", download=[], source=[], documentation=[])
    result, logs = compA1_3(instance)
    assert result == False
...
def test_compA1_3_with_web_and_valid_download():
    instance = create_instance(
        type="web", download=["https://github.com"], source=[], documentation=[]
    )
    result, logs = compA1_3(instance)
    assert result == False
...
def test_compA1_3_with_web_and_valid_source():
    instance = create_instance(type="web", download=[], source=["bioconda"], documentation=[])
    result, logs = compA1_3(instance)
    assert result == False
...
def test_compA1_3_with_web_and_true_inst_intr():
    instance = create_instance(
        type="web", download=[], source=["bioconda"], documentation=[], inst_instr=True
    )
    result, logs = compA1_3(instance)
    assert result == False
...
def test_compA1_3_with_cmd_and_true_inst_intr():
    instance = create_instance(
        type="cmd", download=[], source=["bioconda"], documentation=[], inst_instr=True
    )
    result, logs = compA1_3(instance)
    assert result == True
...
def test_compA1_3_with_none_type():
    instance = create_instance(type=None, download=[], source=[], documentation=[])
    result, logs = compA1_3(instance)
    assert result == False
